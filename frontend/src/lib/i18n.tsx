...
const de = {
  ...
  "users.title": "Konten",
  "users.intro":
    "Wer diese Verwaltung öffnen darf — und wozu. Was ein Konto tatsächlich darf, entscheidet der Server bei jeder Anfrage; hier wird nur eingestellt, welche Rolle es hat.",
  "users.role": "Rolle",
  "users.role.viewer": "Lesen",
  "users.role.editor": "Schreiben",
  "users.role.admin": "Verwalten",
  "users.roleHint.viewer": "Sieht Entwürfe, Verlauf und Übersetzungen — ändert nichts.",
  "users.roleHint.editor": "Bearbeitet die gesamte Dokumentation: Seiten, Bilder, Versionen.",
  "users.roleHint.admin": "Zusätzlich Konten, API-Tokens, Branding, Diagnose und Export.",
  "users.you": "(du)",
  "users.lastLogin": "zuletzt angemeldet {date}",
  "users.neverSignedIn": "noch nie angemeldet",
  "users.sessions": "{n} offene Sitzung(en)",
  "users.newTitle": "Konto anlegen",
  "users.username": "Benutzername",
  "users.password": "Passwort",
  "users.create": "Anlegen",
  "users.newHint":
    "Mindestens {n} Zeichen. Das Passwort gibst du der Person selbst weiter — DocuWaves verschickt keine E-Mails.",
  "users.created": "Konto „{name}“ angelegt.",
  "users.roleChanged": "Rolle von „{name}“ geändert.",
  "users.stepDownConfirm":
    "Deine eigene Rolle auf „{role}“ setzen?\n\nDu wirst dabei abgemeldet und kannst diese Konten danach nicht mehr verwalten. Rückgängig machen kann das nur jemand mit der Rolle „Verwalten“.",
  "users.resetPassword": "Passwort neu setzen",
  "users.passwordPrompt":
    "Neues Passwort für „{name}“.\n\nDas Konto wird dabei überall abgemeldet. Dein eigenes Passwort änderst du unter „Konto“.",
  "users.passwordTooShort": "Mindestens {n} Zeichen.",
  "users.passwordSet": "Passwort für „{name}“ gesetzt, {n} Sitzung(en) beendet.",
  "users.deleteConfirm":
    "Konto „{name}“ wirklich löschen? Die Person wird überall abgemeldet. Was sie geschrieben hat, bleibt mit ihrem Namen im Verlauf stehen.",
  "users.deleted": "Konto „{name}“ gelöscht.",
  "users.readOnlyNotice":
    "Dein Konto darf hier lesen, aber nichts ändern. Entwürfe, Verlauf und Übersetzungen sind sichtbar; Speichern, Anlegen und Löschen nicht.",
  ...
  "diag.chat": "Doku-Chat",
  "diag.chatOff": "nicht eingerichtet",
  "diag.content": "Inhalt",
  ...
  "chat.checkSources": "Antworten können danebenliegen — im Zweifel die verlinkten Seiten lesen.",
  "chat.noSources":
...
const en: Dict = {
  ...
  "users.intro":
    "Who may open this admin area, and as what. What an account may actually do is decided by the server on every request; this only sets which role it has.",
  "users.role": "Role",
  "users.role.viewer": "Read",
  "users.role.editor": "Write",
  "users.role.admin": "Manage",
  "users.roleHint.viewer": "Sees drafts, history and translations -- changes nothing.",
  "users.roleHint.editor": "Edits all of the documentation: pages, images, versions.",
  "users.roleHint.admin": "Also accounts, API tokens, branding, diagnostics and the export.",
  "users.you": "(you)",
  "users.lastLogin": "last signed in {date}",
  "users.neverSignedIn": "never signed in",
  "users.sessions": "{n} open session(s)",
  "users.newTitle": "Create an account",
  "users.username": "Username",
  "users.password": "Password",
  "users.create": "Create",
  "users.newHint":
    "At least {n} characters. You pass the password to the person yourself -- DocuWaves sends no email.",
  "users.created": "Account \"{name}\" created.",
  "users.roleChanged": "Role of \"{name}\" changed.",
  "users.stepDownConfirm":
    "Set your own role to \"{role}\"?\n\nYou will be signed out and will no longer be able to manage these accounts. Only somebody with the \"Manage\" role can undo it.",
  "users.resetPassword": "Set a new password",
  "users.passwordPrompt":
    "New password for \"{name}\".\n\nThis signs that account out everywhere. Your own password is under \"Account\".",
  "users.passwordTooShort": "At least {n} characters.",
  "users.passwordSet": "Password set for \"{name}\"; {n} session(s) ended.",
  "users.deleteConfirm":
    "Really delete the account \"{name}\"? They are signed out everywhere. What they wrote keeps their name on it in the history.",
  "users.deleted": "Account \"{name}\" deleted.",
  "users.readOnlyNotice":
    "Your account can read here but not change anything. Drafts, history and translations are visible; saving, creating and deleting are not.",
  ...
  "chat.checkSources": "Answers can be wrong -- when it matters, read the pages linked above.",
  "chat.noSources":
